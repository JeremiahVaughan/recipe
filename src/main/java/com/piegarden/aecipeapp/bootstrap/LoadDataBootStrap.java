package com.piegarden.aecipeapp.bootstrap;

import com.piegarden.aecipeapp.domain.*;
import com.piegarden.aecipeapp.repositories.CategoryRepository;
import com.piegarden.aecipeapp.repositories.RecipeRepository;
...
@Slf4j
@Component
public class LoadDataBootStrap
    ...
    public LoadDataBootStrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
    ...
    private List<Recipe> getRecipes() {
        ...
        //get optionals
        log.debug("Unit of measures loaded");
